...
class __TwigTemplate_e74a4433eec1a3e06c95293ba9f9e8f3d38c6ce8971a0bcab1f50e49712fde3a extends Twig_Template
{
    ...
    {
        $tags = array("set" => 42, "if" => 63, "for" => 66);
...
";
        // line 57
        $context["my_id"] = array(0 => ("field--name-" . \Drupal\Component\Utility\Html::getClass(        // line 58
...
";
  ...
  ";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                    // line 72
                    echo " <!--   <section ";
                    echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute(($context["attributes"] ?? null), "setAttribute", array(0 => "id", 1 => ($context["my_id"] ?? null)), "method"), "html", null, true));
                    echo " > -->
      <div  ";
                    // line 73
   ...
   <!--   </section> -->
    ...
    ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                // line 84
                echo "    <section ";
                echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute(($context["attributes"] ?? null), "setAttribute", array(0 => "id", 1 => "field--item"), "method"), "html", null, true));
                echo ">
      <div";
                // line 85
                echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute($this->getAttribute($context["item"], "attributes", array()), "addClass", array(0 => "field--item"), "method"), "html", null, true));
...
";
    ...
    {
        return array (  160 => 91,  156 => 89,  153 => 88,  142 => 85,  137 => 84,  132 => 83,  128 => 81,  126 => 80,  120 => 79,  115 => 78,  111 => 76,  100 => 73,  95 => 72,  90 => 71,  86 => 69,  75 => 67,  71 => 66,  66 => 65,  63 => 64,  61 => 63,  57 => 61,  55 => 58,  54 => 57,  51 => 55,  49 => 52,  48 => 50,  46 => 46,  45 => 45,  44 => 44,  43 => 42,);
    }
    ...
    {
        return new Twig_Source("", "themes/bootstrap/templates/field/field.html.twig", "/Applications/MAMP/htdocs/shaio/themes/bootstrap/templates/field/field.html.twig");
    }
}
